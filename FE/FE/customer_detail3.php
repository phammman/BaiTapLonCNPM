...
<div style="font-family:Arial, sans-serif; max-width:1200px; margin:20px auto;">
  ...
  <div style="background:#fff; border:1px solid #ddd; border-radius:8px; padding:20px;">
    ...
    <button onclick="if(confirm('Bạn có chắc chắn muốn xoá khách hàng này không?')) { window.location.href='delete_customer.php?MaKH=<?php echo $khachhang['MaKH']; ?>'; }" 
            style="padding:8px 14px; background:#dc3545; color:#fff; border:none; border-radius:5px; cursor:pointer; font-size:14px;">
      Xoá
    </button>
  </div>
