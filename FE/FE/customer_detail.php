    ...
    foreach ($donhangs as $dh) { ?>
      <div style="display:flex; justify-content:space-between; padding:10px 0; border-bottom:1px solid #eee;">
        ...
        <div style="text-align:right;">
          <span style="background:#e6f4ea; color:#137333; padding:3px 8px; border-radius:12px; font-size:12px; margin-right:5px;">
            <?php echo $dh['TrangThai']=="Đã thanh toán" ? "Đã thanh toán" : $dh['TrangThai']; ?>
          </span>
