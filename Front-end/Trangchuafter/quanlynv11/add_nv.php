  ...
  <form class="app" action="add.php" method="post">
    ...
    <div class="main">
        <!-- Left column -->
         <section class="content">
            <div class="topbutton">
                <button onclick="location.href='/Chuyen_de_dinh_huong_CNPM/Front-end/Trangchuafter/employee.php'">&larr;</button>
            ...
            <div class="card">
              <div class="form-grid">
                ...
                <div class="left">
                    ...
                    <input type="text" id="fullname" name="HoTen" placeholder="Nhập tên nhân viên" required>
                ...
                <div class="right">
                  ...
                  <label for="position">Chọn chức vụ</label>
                    <select id="position" name="ChucVu" required>
