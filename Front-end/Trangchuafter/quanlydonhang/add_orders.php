  ...
  $khachhang_sql = "SELECT MaKH, HoTen FROM khachhang";
  $khachhang_result = $conn->query($khachhang_sql);

  // Lấy danh sách nhân viên
  $nhanvien_sql = "SELECT MaNV, HoTen FROM nhanvien";
      ...
      <div class="main">
          ...
          <section class="content2">
              ...
              <div class="product-section card">
                ...
                <!-- <div id="selectedProducts2" style="margin-top: 20px;"></div> -->
  ...
  card.innerHTML = `
    ...
    <div>
      ...
      <input type="number" value="1" min="1" 
            data-price="${gia}" 
            class="soluong-input"
            name="SoLuong[${product.MaSP}]"
            style="width:60px; padding:4px; border:1px solid #ddd; border-radius:6px;margin-right:50px">
    </div>
    <!-- Input ẩn gửi mã và giá sản phẩm -->
    <input type="hidden" name="MaSP[]" value="${product.MaSP}">
    <input type="hidden" name="GiaSP[${product.MaSP}]" value="${gia}">
  `;
  ...
  updateTotal();
            ...
            <script>
              ...
              <div class="extra-info card" style="margin-top: 20px; border: 1px solid #e5e7eb; border-radius: 10px; padding: 16px; background: #fff;">
                ...
                <div style="margin-bottom: 25px;">
                  <!-- <input type="hidden" name="MaNV" id="hiddenMaNV" value=""> -->
                  ...
                  <select name="MaNV" style="width: 100%; padding: 8px; border: 1px solid #e5e7eb; border-radius: 6px;">
                    ...
                    // kiểm tra kết nối
                    if ($conn) {
                        $sql_nv = "SELECT MaNV, HoTen FROM nhanvien WHERE MaND = '$MaND'";
                        ...
                        if ($result_nv && $result_nv->num_rows > 0) {
                            while ($row_nv = $result_nv->fetch_assoc()) {
                                ...
                                echo "<option value='" . htmlspecialchars($row_nv['MaNV']) . "'>" 
