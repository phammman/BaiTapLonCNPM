...
$active_group = isset($page_group[$current_page]) ? $page_group[$current_page] : '';
?>
...
<aside class="sidebar">
    ...
    <div class="nav-section">
        <a class="nav-item <?php echo ($active_group == 'manuadmin') ? 'active' : ''; ?>" href="../manuadmin.php" style="color: lightblue;">
        ...
        <a class="nav-item <?php echo ($active_group == 'orders') ? 'active' : ''; ?>" href="../orders.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 7h18M3 12h18M3 17h18" stroke-width="1.5"/></svg> Đơn hàng</a>
        <a class="nav-item <?php echo ($active_group == 'products') ? 'active' : ''; ?>" href="../products.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="4" width="18" height="14" rx="2" stroke-width="1.5"/><path d="M7 8h10M7 12h10" stroke-width="1.5"/></svg> Sản phẩm</a>
        <a class="nav-item <?php echo ($active_group == 'inventories') ? 'active' : ''; ?>" href="../inventories.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 9h18M5 9V5h14v4M5 9v10h14V9" stroke-width="1.5"/></svg> Quản lý kho</a>
        <a class="nav-item <?php echo ($active_group == 'employee') ? 'active' : ''; ?>" href="../employee.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4" stroke-width="1.5"/><path d="M4 21c1.5-4 6-6 8-6s6.5 2 8 6" stroke-width="1.5"/></svg> Nhân viên</a>
