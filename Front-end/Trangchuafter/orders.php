            ...
            <div class="left">
                ...
                <div class="card-bd">
                    ...
                    <nav style="display:flex; align-items:center; justify-content:space-between; gap:12px;">
                        ...
                        <a href="quanlydonhang/add_orders.php"><button class="btn primary">Thêm đơn hàng</button></a>
                        </div>
                    </nav>
                    ...
                    <table style="width:100%; border-collapse:collapse; background:#fff;">
                        <thead>
                            <tr style="background:#fafafa; color:var(--muted); text-align:left;">
                                ...
                                <th style="padding:14px; border-bottom:1px solid var(--border); width:200px;">Mã đơn hàng</th>
                                <th style="padding:14px; border-bottom:1px solid var(--border); width:200px;">Ngày đặt</th>
                                <th style="padding:14px; border-bottom:1px solid var(--border); width:200px;">Khách hàng</th>
                                <th style="padding:14px; border-bottom:1px solid var(--border); width:200px;">Thành tiền</th>
                                <th style="padding:14px; border-bottom:1px solid var(--border); width:200px;">Trạng thái</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if ($result && $result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td style='padding:14px; border-bottom:1px solid #f1f5f9;'>" .
                                            htmlspecialchars($row['TenKH']) . "</td>";
                                    echo "<td style='padding:14px; border-bottom:1px solid #f1f5f9;'>" .
                                            number_format($row['ThanhTien'], 0, ',', '.') . " đ</td>";
                                    echo "<td style='padding:14px; border-bottom:1px solid #f1f5f9;'>" .
