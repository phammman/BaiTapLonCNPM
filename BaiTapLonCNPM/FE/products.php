    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        <div class="nav-section">
          ...
          <a class="nav-item" href="products.php" style="color: lightblue;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="4" width="18" height="14" rx="2" stroke-width="1.5"/><path d="M7 8h10M7 12h10" stroke-width="1.5"/></svg> Sản phẩm</a>
