...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $MaKH = $_POST["MaKH"];
    $MaNV = $_POST["MaNV"];
     $sql = "INSERT INTO donhang (MaDH, NgayLap, TrangThai, MaKH, MaNV) VALUES ('$MaDH', '$NgayLap', '$TrangThai', '$MaKH', '$MaNV')";
...
<div class="container">
    ...
    <form class="form-group" method="post">
        <label>Mã ĐH:</label><input type="text" name="MaDH" required><br>
        <label>Ngày Lập:</label><input type="date" name="NgayLap" required><br>
        <label>Trạng Thái:</label><input type="text" name="TrangThai" value="" required><br>
