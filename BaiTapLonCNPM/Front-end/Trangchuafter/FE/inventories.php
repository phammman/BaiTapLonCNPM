    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        <div class="nav-section">
          ...
          <a class="nav-item" href="inventories.php" style="color: lightblue;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 9h18M5 9V5h14v4M5 9v10h14V9" stroke-width="1.5"/></svg> Quản lý kho</a>
          ...
          <a class="nav-item" href="SoQuy.php"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="5" width="18" height="14" rx="2" stroke-width="1.5"/><path d="M7 9h6M7 13h10" stroke-width="1.5"/></svg> Sổ quỹ</a>
                ...
                <div class="card-bd">
                    ...
                    <table style="width:100%; border-collapse:collapse; background:#fff;">
                        ...
                        <tr style="background:#fafafa; color:var(--muted); text-align:left;">
                            ...
                            <th style="padding:14px; border-bottom:1px solid var(--border); width:120px;">SKU</th>
                            <th style="padding:14px; border-bottom:1px solid var(--border); width:150px;">Tồn kho</th>
                            <th style="padding:14px; border-bottom:1px solid var(--border); width:200px;">Giá bán</th>
                            <th style="padding:14px; border-bottom:1px solid var(--border); width:160px;">Giá vốn</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            ...
                            <td style="padding:14px; border-bottom:1px solid #f1f5f9;">12</td>
                            <td style="padding:14px; border-bottom:1px solid #f1f5f9;">100</td>
                            <td style="padding:14px; border-bottom:1px solid #f1f5f9;">50.000</td>
                            <td style="padding:14px; border-bottom:1px solid #f1f5f9;">20.000</td>
                        </tr>
                        </tbody>
                    </table>
                    </div>
