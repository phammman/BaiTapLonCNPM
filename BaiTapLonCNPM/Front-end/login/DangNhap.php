<?php
session_start();
include "../Trangchuafter/FE/connect.php"; // đảm bảo đường dẫn đúng
...
<body>
    ...
    <header>
        <nav class="navbar">
            ...
            <div class="menu">
                ...
                <a href="#">Thêm ▾</a>
                <a href="dangKy.php"><button class="btn-register">Đăng ký</button></a>
            </div>
        </nav>
    </header>
    ...
    <div class="box">
        <form id="formDangNhap" action="dangNhap.php" method="post">
            ...
            <div class="dau_vao">
                ...
                <input type="text" id="tenDangNhap" placeholder="Nhập tên đăng nhập của bạn" name="tenDangNhap" value="<?php echo isset($username) ? htmlspecialchars($username) : ''; ?>">
            </div>
            ...
            <?php if ($error_message != ""): ?>
                <span class="error" style="display:block;"><?php echo $error_message; ?></span>
            <?php endif; ?>
            <div class="btn">
    ...
    <div class="footer">
        <div class="footer-content">
            ...
            <p>Để trải nghiệm phần mềm quản lý bán hàng hiệu quả nhất.</p> <button class="btn-free-trial">Bắt Đầu Trải Nghiệm</button>
        </div>
        <div class="footer-columns">
            <div class="footer-column">
                <h3>Quản Lý Cửa Hàng</h3> <a href="#">Giới thiệu</a> <a href="#">Tin tức</a> <a href="#">Liên hệ</a>
            </div>
            <div class="footer-column">
                <h3>Giải pháp</h3> <a href="#">Quản lý bán hàng</a> <a href="#">Quản lý kho</a> <a href="#">Quản lý đơn hàng</a>
            </div>
            <div class="footer-column">
                <h3>Sản phẩm</h3> <a href="#">Phần mềm quản lý</a> <a href="#">Ứng dụng di động</a> <a href="#">Thiết bị bán hàng</a>
            </div>
            <div class="footer-column">
                <h3>Hỗ trợ</h3> <a href="#">Trung tâm hỗ trợ</a> <a href="#">Câu hỏi thường gặp</a> <a href="#">Tài liệu hướng dẫn</a>
            </div>
            <div class="footer-column">
                <h3>Social</h3> <a href="#">Facebook</a> <a href="#">Instagram</a> <a href="#">LinkedIn</a>
            </div>
        </div>
    </div>
    </div>
